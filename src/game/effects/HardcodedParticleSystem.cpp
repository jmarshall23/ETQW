...
#pragma warning( disable: 4311 )
	const int uid = static_cast< int >( reinterpret_cast< UINT_PTR >( renderEntity->callbackData ) );
	sdHardcodedParticleSystem* me = (sdHardcodedParticleSystem*)renderSystem->PtrForUID( uid );
#pragma warning( pop )
