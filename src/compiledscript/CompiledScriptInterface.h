...
const int COMPILED_SCRIPT_INTERFACE_VERSION = 3;
...
public:
	...
	virtual int						GetClassVariableInfoSize( void ) = 0;
	virtual int						GetClassInfoSize( void ) = 0;
	virtual int						GetPointerSize( void ) = 0;
