...
public:
	...
	virtual int						GetClassVariableInfoSize( void ) { return sizeof( sdClassVariableInfo ); }
	virtual int						GetClassInfoSize( void ) { return sizeof( sdClassInfo ); }
	virtual int						GetPointerSize( void ) { return sizeof( void* ); }
