...
extern void glBox(const idVec4 &color, const idVec3 &point, float size);
extern void glLabeledPoint(const idVec4 &color, const idVec3 &point, float size, const char *label);
