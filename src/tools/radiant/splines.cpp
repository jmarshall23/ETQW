...
================
*/
void glLabeledPoint(const idVec4 &color, const idVec3 &point, float size, const char *label) {
...
================
*/
void glBox(const idVec4 &color, const idVec3 &point, float size) {
	idVec3 mins(point);
	idVec3 maxs(point);
	mins[0] -= size;
	mins[1] += size;
...
================
*/
void debugLine(const idVec4 &color, float x, float y, float z, float x2, float y2, float z2) {
	idVec3 from(x, y, z);
	idVec3 to(x2, y2, z2);
