...
extern idCVar r_softParticles;			// enable soft-particle depth fading
extern idCVar r_megaDrawMethod;			// ETQW batched interaction path
extern idCVar r_useAlphaToCoverage;		// multisample alpha coverage
...
void R_GenerateViewMatrix( const idMat3& axis, const idVec3& origin, float* out );
...
void	R_ARB2_ReparseRenderPrograms( void );
