...
// ETQW publishes this limit through NetworkSystem.h.
...
public:
	...
	static void				WriteUserCmdDelta( idBitMsg &msg, const usercmd_t &cmd, const usercmd_t *base, int timeOffset = 0 );
	...
	static idCVar			clientPunkbusterEnabled;		// retained for ETQW GUI/profile compatibility
	static idCVar			serverPunkbusterEnabled;		// retained for ETQW server-info compatibility
